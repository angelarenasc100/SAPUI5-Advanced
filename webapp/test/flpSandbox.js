		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#alfa04employees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"alfa04employees-display": {
								"semanticObject": "alfa04employees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=alfa04.employees",
									"url": sap.ui.require.toUrl("alfa04/employees")
								}
							}
						}
					}
